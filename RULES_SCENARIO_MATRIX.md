...
| **T3**  | Territory | `Rules_12_2_Q23_region_not_processed_without_self_elimination_square19`, `Rules_12_2_Q23_region_processed_with_self_elimination_square19` | §12.2, FAQ 23 – self-elimination prerequisite for disconnected regions | `tests/unit/GameEngine.territory.scenarios.test.ts`                   | `tests/unit/TerritoryParity.GameEngine_vs_Sandbox.test.ts` (backend↔sandbox Q23-positive, Q23-negative, and two-region multi-region parity on square19) | COVERED |
