...
|                                                    | Compact rules §9; `archive/RULES_ANALYSIS_PHASE2.md` §4 | `backend_vs_sandbox_trace_parity_seed5`       | 8×8 (seeded AI)            | Backend, Sandbox, Traces                                                                                                                                                                                                                                                                                                                                                                                                          | `tests/unit/Backend_vs_Sandbox.traceParity.test.ts`; `tests/unit/Backend_vs_Sandbox.seed5.checkpoints.test.ts`; `tests/unit/Backend_vs_Sandbox.seed5.internalStateParity.test.ts`; `tests/unit/Backend_vs_Sandbox.seed5.bisectParity.test.ts`                                                                                      | PARTIAL |
