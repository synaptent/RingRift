...
// Archived diagnostic parity harness:
// - Original location: tests/unit/TerritoryParity.GameEngine_vs_Sandbox.test.ts
// - Classification: backend ↔ sandbox territory-parity on a canonical 19x19
//   disconnected-region scenario, validating shared territory detection and
//   processing.
// - Status: superseded by shared territoryDecisionHelpers + RulesMatrix/FAQ
//   Q23 suites; retained here for historical/debug reference only and not
//   discovered by Jest (archive/ is outside Jest roots).
