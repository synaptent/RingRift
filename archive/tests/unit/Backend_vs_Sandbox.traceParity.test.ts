...
/**
 * Archived backend vs sandbox trace-based parity checks (trace-level).
 *
 * Original location: tests/unit/Backend_vs_Sandbox.traceParity.test.ts
 *
 * Classification:
 ...
 *   RefactoredEngine/Parity, LineDetectionParity, Seed14Move35LineParity, and
 *   the RulesMatrix/FAQ suites listed in RULES_SCENARIO_MATRIX.md.
 *
 * Status:
 * - Superseded by shared decision-helper tests, contract vectors, and targeted
 *   parity suites; retained here as a small historical/diagnostic harness that
 *   is no longer discovered by Jest (archive/ is outside Jest roots).
 */
