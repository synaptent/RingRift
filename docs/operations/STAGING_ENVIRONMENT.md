...
[`docs/PRODUCTION_READINESS_CHECKLIST.md`](../production/PRODUCTION_READINESS_CHECKLIST.md:104):
...
- Uses staging thresholds for k6 (`THRESHOLD_ENV=staging`) and applies stricter, production-level SLOs
  ...
  [`docs/PRODUCTION_READINESS_CHECKLIST.md`](../production/PRODUCTION_READINESS_CHECKLIST.md:176) and
...
[`docs/PRODUCTION_READINESS_CHECKLIST.md`](../production/PRODUCTION_READINESS_CHECKLIST.md:245).
...
- [`docs/operations/ALERTING_THRESHOLDS.md`](ALERTING_THRESHOLDS.md) - Alert configuration
