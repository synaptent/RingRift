...
- **Environment:** staging stack as described in [`docs/STAGING_ENVIRONMENT.md`](../operations/STAGING_ENVIRONMENT.md:1).
...
- **Environment:** staging or dedicated perf stack configured per [`docs/STAGING_ENVIRONMENT.md`](../operations/STAGING_ENVIRONMENT.md:1); thresholds evaluated with `--env production`.
...
1. Deploy or refresh the staging or perf environment per [`docs/STAGING_ENVIRONMENT.md`](../operations/STAGING_ENVIRONMENT.md:56).
