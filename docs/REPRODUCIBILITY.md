...
**hex8_2p**: 1500 → 2028.3 Elo in 20 iterations on the v5-heavy + fv3 reference lane using fixed learning rate self-play. The previous v3-family line reached 1979.8 Elo in 33 iterations and remains documented below as historical context.
...
### hex8_2p fv3 reference (current frontier: 1500 → 2028.3 Elo, 6 promotions)
...
[`docs/data/training_runs/2026-05-01/gh200-14_fv3_iter20_frontier`](/docs/data/training_runs/2026-05-01/gh200-14_fv3_iter20_frontier).
...
└── gh200-14/         # hex8_2p fv3 reference frontier (2028.3 Elo) and other experiments
```
