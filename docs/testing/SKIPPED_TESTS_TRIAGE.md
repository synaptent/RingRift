...
| ~~`Backend_vs_Sandbox.CaptureAndTerritoryParity.test.ts`~~                                                                 | ~~combined line + territory parity~~                             | ~~traceMode breaks on line_order after choose_line_reward~~                     | ~~B~~    | **DELETED**  | **2025-12-11**: Test file no longer exists; functionality covered by other parity tests                                           |
