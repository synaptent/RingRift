...
- If symptoms look like **rules-engine issues** (illegal moves accepted, incorrect scoring/turn sequencing) rather than “AI is slow”, escalate via `docs/ORCHESTRATOR_ROLLOUT_PLAN.md` (Safe rollback checklist) instead of improvising rules changes here.
