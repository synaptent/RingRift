...
**Evidence from [`GamePage.tsx:1-50`](../../../src/client/pages/GamePage.tsx):**
...
| [`useGameConnection.ts`](../../../src/client/hooks/useGameConnection.ts) | 290 | Hardcoded 8-second staleness threshold (line 31) |
...
| ------------------------ | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Invalid runbook URLs     | [`alertmanager.yml:50-70`](../../../monitoring/alertmanager/alertmanager.yml)       | References non-existent runbooks like `/docs/runbooks/ai_service_down.md` |
...
| Generic severity routing | [`alertmanager.yml:100-130`](../../../monitoring/alertmanager/alertmanager.yml) | Routing based on severity alone, missing service-specific routes |

**Valid Runbooks Found:**

- [`docs/runbooks/DATABASE_MIGRATION.md`](../../runbooks/DATABASE_MIGRATION.md) ✅
- [`docs/runbooks/DEPLOYMENT_ROUTINE.md`](../../runbooks/DEPLOYMENT_ROUTINE.md) ✅
- [`docs/runbooks/DEPLOYMENT_ROLLBACK.md`](../../runbooks/DEPLOYMENT_ROLLBACK.md) ✅
...
1. [`archive/REMAINING_IMPLEMENTATION_TASKS.md`](../../../archive/REMAINING_IMPLEMENTATION_TASKS.md) lists "Implement server-side session persistence" as P0, but [`docs/runbooks/DEPLOYMENT_ROUTINE.md`](../../runbooks/DEPLOYMENT_ROUTINE.md) implies session persistence is operational.
...
**Evidence from [`tests/setup.ts:60-108`](../../../tests/setup.ts):**
...
2. **File:** [`src/client/components/GameHUD.tsx`](../../../src/client/components/GameHUD.tsx)
   - **Lines:** 888
