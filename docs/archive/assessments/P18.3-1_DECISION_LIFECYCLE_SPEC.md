...
- Invariants in [`INVARIANTS_AND_PARITY_FRAMEWORK.md`](../../rules/INVARIANTS_AND_PARITY_FRAMEWORK.md:1)
...
UI note: Client HUD and dialog countdowns consume these millisecond deadlines and warnings and render whole-second values using ceil semantics via [`msToDisplaySeconds()`](../../../src/client/utils/countdown.ts:43); these countdowns are advisory only, with authoritative expiry still defined by the guards in [`GameSession.handleDecisionPhaseTimedOut()`](../../../src/server/game/GameSession.ts:1512) and the resulting `game_state` transitions.
...
- PASS18 planning docs:
  - [`PASS18_REMEDIATION_PLAN.md`](PASS18_REMEDIATION_PLAN.md:1)
  - [`PASS18_WORKING_NOTES.md`](PASS18_WORKING_NOTES.md:1)
    will reference this file as the SSoT for decision lifecycle semantics.
- Related host/rules specs:
  - [`P18.1-1_CAPTURE_TERRITORY_HOST_MAP.md`](P18.1-1_CAPTURE_TERRITORY_HOST_MAP.md:1)
  - [`P18.2-1_AI_RNG_PATHS.md`](P18.2-1_AI_RNG_PATHS.md:1)
  - [`RULES_CANONICAL_SPEC.md`](../../../RULES_CANONICAL_SPEC.md:1)
  - [`INVARIANTS_AND_PARITY_FRAMEWORK.md`](../../rules/INVARIANTS_AND_PARITY_FRAMEWORK.md:1)
