...
**Location:** `deprecated/` folder (removed)
...
- [`ARCHITECTURE_ASSESSMENT.md`](../plans/ARCHITECTURE_ASSESSMENT.md)
...
8. **Orchestrator Tests:** Confirmed [`OrchestratorRolloutService.test.ts`](../../../tests/unit/OrchestratorRolloutService.test.ts) (802 lines) exists; ShadowModeComparator tests have been removed (see `tests/TEST_LAYERS.md`)
