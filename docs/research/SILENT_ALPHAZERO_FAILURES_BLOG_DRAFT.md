...
15, iter 20, iter 34, and then iter 42, which reached `2327.8` Elo after a
`52.0%` stage-4 verdict over 400 games. That is now the strongest `hex8_2p` checkpoint in the project. Without
