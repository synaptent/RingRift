...
As of April 9, 2026, the strongest reported results are:

| Config       | Best Reported Elo | Promotions | Notes                                                                        |
| ------------ | ----------------: | ---------: | ---------------------------------------------------------------------------- |
| `hex8_2p`    |          `1967.6` |        `6` | Strongest overall result; clear iterative improvement from the 1500 baseline |
| `square8_2p` |          `1601.8` |        `2` | Clean fixed-LR run now promotes under the corrected experiment harness       |
| `square8_3p` |          `1534.9` |        `1` | Promising multiplayer evidence, but weaker than the 2-player path            |
