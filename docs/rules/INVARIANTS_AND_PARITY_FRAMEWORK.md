...
- Documented in [`docs/INCIDENT_TERRITORY_MUTATOR_DIVERGENCE.md`](docs/INCIDENT_TERRITORY_MUTATOR_DIVERGENCE.md:69), the ANM scenario catalogue [`ACTIVE_NO_MOVES_BEHAVIOUR.md`](ACTIVE_NO_MOVES_BEHAVIOUR.md:100), and the Python active-no-moves regression tests.
...
| **Python tests** | The ANM invariant suites (see `INV-ACTIVE-NO-MOVES`) plus [`test_territory_forced_elimination_divergence.py`](docs/INCIDENT_TERRITORY_MUTATOR_DIVERGENCE.md:229) validate that `_update_phase` and `_end_turn` mirror TS phase semantics and correctly skip permanently eliminated players.                                                                                                                           |
...
- **B4‑1 – Per‑invariant metrics with IDs** (`INV-STATE-STRUCTURAL`, `INV-S-MONOTONIC`, `INV-ACTIVE-NO-MOVES`, `INV-ORCH-VALIDATION`, `INV-TERMINATION`)
  ...
  - Update [`monitoring/prometheus/alerts.yml`](monitoring/prometheus/alerts.yml:583) and [`docs/operations/ALERTING_THRESHOLDS.md`](docs/operations/ALERTING_THRESHOLDS.md:561) to document and use these labels.
