...
| WS.W2 – Staging HTTP Move Harness Baseline  | Staging             | [`player-moves.js`](tests/load/scenarios/player-moves.js:1) with `ENABLE_HTTP_MOVE_HARNESS=true` and `MOVE_HTTP_ENDPOINT_ENABLED=true`                                                                                                                                                                                                                                                                                                                                           | Staging HTTP move SLOs validated against thresholds.                                        | WS.W2 staging baseline recorded in [LOAD_TEST_BASELINE.md](docs/testing/LOAD_TEST_BASELINE.md:1) and [LOAD_TEST_BASELINE_REPORT.md](docs/testing/LOAD_TEST_BASELINE_REPORT.md:1). |
...
- **Done when**
  - All above scenarios complete without k6 aborts (no repeat of the dev 429 storm described in [LOAD_TEST_BASELINE_REPORT.md](docs/testing/LOAD_TEST_BASELINE_REPORT.md:1)).
...
- **Done when**
  - A WS.W2 staging baseline entry exists in:
    - [LOAD_TEST_BASELINE.md](docs/testing/LOAD_TEST_BASELINE.md:1)
...
- **Done when**
  - Perf / pre‑prod baselines for WS.W4 exist in:
    - [LOAD_TEST_BASELINE.md](docs/testing/LOAD_TEST_BASELINE.md:1)
    - [LOAD_TEST_BASELINE_REPORT.md](docs/testing/LOAD_TEST_BASELINE_REPORT.md:1)
  - Category 8 go / no‑go gates for move SLOs (to be added in [GO_NO_GO_CHECKLIST.md](docs/testing/GO_NO_GO_CHECKLIST.md:1)) are satisfied.
...
- [x] Add filtering (by time period, board type) - Added 2025-12-10
  - `boardType`: all, square8, square19, hexagonal
