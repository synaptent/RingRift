...
**Update (2025-12-12):** The current canonical DB gate summaries live under `ai-service/data/games/db_health.*.json`. As of 2025-12-12, `canonical_square8_4p.db` is failing the parity gate (`canonical_ok=false`) and is not yet eligible for canonical training.
