...
- [x] Implement game serialization to database - SQLite schema v7 at the time (current v15)
...
- `game_replay.py` (~95KB) - Full DB management with schema v7 at the time (current v15)
