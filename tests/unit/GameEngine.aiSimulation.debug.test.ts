...
// Skip with orchestrator adapter - this test checks S-invariant progress which may
// behave differently with the orchestrator adapter's unified processing flow.
const skipWithOrchestrator = process.env.ORCHESTRATOR_ADAPTER_ENABLED === 'true';

(skipWithOrchestrator ? describe.skip : describe)(
  'GameEngine AI simulation debug: square8 with 2 AI players, seed=1',
  () => {
