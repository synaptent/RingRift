...
describe('AIEngine Fallback Handling', () => {
  ...
  describe('Diagnostics Tracking', () => {
    ...
    it('treats AI_SERVICE_OVERLOADED / overloaded aiErrorType as a recoverable failure', async () => {
      const overloadedError: any = new Error('AI service overloaded: too many concurrent requests');
      overloadedError.aiErrorType = 'overloaded';
      overloadedError.code = 'AI_SERVICE_OVERLOADED';

      mockAIServiceClient.getAIMove.mockRejectedValue(overloadedError);
