...
describe('MoveAnalysisPanel', () => {
  ...
  describe('move type display', () => {
    const moveTypeTestCases = [
      ...
      { type: 'skip_placement', expected: 'Placement (no action)' },
      { type: 'no_placement_action', expected: 'Placement (no action)' },
      ...
      { type: 'skip_capture', expected: 'Skip Capture' },
      { type: 'process_line', expected: 'Line Processing' },
      { type: 'choose_line_option', expected: 'Line Processing' },
      { type: 'choose_line_reward', expected: 'Line Processing' },
      { type: 'no_line_action', expected: 'Line Processing' },
