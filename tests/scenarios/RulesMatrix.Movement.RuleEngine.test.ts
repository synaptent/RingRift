  ...
  test.each<MovementRuleScenario>(scenarios)(
    ...
    (scenario) => {
      ...
      if (scenario.ref.id.startsWith('Rules_8_2_Q2_minimum_distance')) {
        ...
        // Per RR-CANON-R091/R092, landing on ANY marker (own or opponent) is valid.
        // Both own marker and opponent marker landing positions should be in targets.
        if (scenario.boardType === 'square8') {
          ...
          expect(targetsFromOrigin).toContain(oppKey); // Now allowed per RR-CANON-R091/R092
