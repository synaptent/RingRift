  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      <header>
        ...
        <p className="text-sm text-gray-500">Join an existing game or create a new one.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold text-gray-200">Available Games</h2>
            <button
          ...
          {isLoadingGames ? (
            ...
            <div className="p-8 text-center bg-slate-900/50 rounded-lg border border-slate-800 text-gray-500">
            ...
            <div className="space-y-3">
              {availableGames.map((game) => (
                <div
                  key={game.id}
                  className="p-4 bg-slate-800 rounded-lg border border-slate-700 hover:border-slate-600 transition-colors flex justify-between items-center"
                >
                  <div>
                    ...
                    <div className="text-xs text-gray-400 flex space-x-3">
                      ...
                      <span>•</span>
                      <span>
                        {game.timeControl.type} ({game.timeControl.initialTime / 60}m +{' '}
                        {game.timeControl.increment}s)
                      </span>
                      <span>•</span>
        ...
        {/* Create Game Section */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-200">Create Game</h2>
          <form
            onSubmit={handleSubmit}
            className="p-4 rounded-md bg-slate-900 border border-slate-700 space-y-4"
          >
            {error && (
              <div className="p-2 text-sm text-red-300 bg-red-900/40 border border-red-700 rounded">
                {error}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                <div>
                  ...
                  <input
                    ...
                    value={form.aiCount}
                    onChange={(e) =>
                      handleChange('aiCount', Math.max(0, Math.min(3, Number(e.target.value))))
                    }
                  />
                </div>
