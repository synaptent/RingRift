...
export class AIEngine {
  ...
  static getAIDescription(difficulty: number): string {
    const descriptions: Record<number, string> = {
      ...
      5: 'Level 5 – Descent: Neural search with stronger global planning',
      6: 'Level 6 – Descent: Neural search with higher budget',
      7: 'Level 7 – MCTS: Heuristic-only search with large budget',
      8: 'Level 8 – MCTS: Neural-guided search with larger budget',
      9: 'Level 9 – Gumbel MCTS: High-end neural search',
      10: 'Level 10 – Gumbel MCTS: Strongest available engine; very challenging',
    };
