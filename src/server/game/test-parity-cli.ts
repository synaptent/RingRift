...
async function main() {
  ...
  try {
    ...
    // TS MoveType: 'place_ring', 'move_stack', 'overtaking_capture', 'continue_capture_segment', 'process_line', 'choose_line_option', 'choose_territory_option' (legacy alias: 'choose_territory_option'), 'eliminate_rings_from_stack', 'line_formation', 'territory_claim', 'skip_placement'
