...
CMAES_MAX_CONCURRENT_EVALS_OVERRIDE="${RINGRIFT_P2P_MAX_CONCURRENT_CMAES_EVALS:-}"
...
append_env_if_int "RINGRIFT_P2P_MAX_CONCURRENT_CMAES_EVALS" "$CMAES_MAX_CONCURRENT_EVALS_OVERRIDE"
...
RINGRIFT_P2P_MAX_CONCURRENT_CMAES_EVALS=$CMAES_MAX_CONCURRENT_EVALS_OVERRIDE
