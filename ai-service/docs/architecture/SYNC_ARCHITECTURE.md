...
**Canonical Doc:** `ai-service/docs/sync_architecture.md`

This file is retained for backward links. The canonical sync architecture lives in
`ai-service/docs/sync_architecture.md` and reflects the December 2025 consolidation:
...
archive or dated consolidation reports under `ai-service/docs/archive/`.
