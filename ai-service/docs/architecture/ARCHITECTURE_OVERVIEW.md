...
| D2    | Heuristic   | `heuristic_ai.py` (weakened weights)            |
| D3    | Heuristic   | `heuristic_ai.py` (CMA-ES tuned weights)        |
| D4    | Minimax     | `minimax_ai.py` (alpha-beta + NNUE neural eval) |
| D5    | Minimax     | `minimax_ai.py` (higher-budget NNUE)            |
| D6    | Descent     | `descent_ai.py` (neural UBFM/Descent search)    |
