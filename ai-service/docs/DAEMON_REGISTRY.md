...
**Total Daemon Types:** 89 (89 async runners in `daemon_runners.py`, 6 deprecated as of Dec 30, 2025)
...
- Monitoring (MEMORY_MONITOR, QUALITY_MONITOR, CLUSTER_MONITOR, METRICS_ANALYSIS)
