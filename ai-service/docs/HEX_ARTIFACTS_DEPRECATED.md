...
The current "ultimate hex" specification is **radius 12 (13‑side board)** with **469 cells** and **96 rings per player**, embedded in a **25×25** grid. All hex artifacts listed below are **deprecated** and **must not** be used for training, evaluation, or parity after the geometry change.
...
- Regenerate new hex training data, parity fixtures, and models under the **radius 12 / 469‑cell / 96‑ring / 25×25** geometry.
