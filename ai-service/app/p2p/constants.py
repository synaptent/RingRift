...
try:
    ...
    DISK_SYNC_TARGET_PERCENT = _DISK_SYNC  # Re-export for p2p_orchestrator.py
except ImportError:
    ...
    DISK_CLEANUP_THRESHOLD = int(os.environ.get("RINGRIFT_P2P_DISK_CLEANUP_THRESHOLD", "60") or 60)
    DISK_SYNC_TARGET_PERCENT = DISK_WARNING_THRESHOLD  # Fallback: same as warning
...
MAX_CONCURRENT_EXPORTS = int(os.environ.get("RINGRIFT_P2P_MAX_CONCURRENT_EXPORTS", "1") or 1)
