...
def evaluate_positions_kernel(
    ...
    for player in range(1, num_players + 1):
        ...
        # Per BOARD_CONFIGS: 8×8=18, 9×9(hex8)=18, 19×19=72, hex(13)=96 rings per player
        # For 2p: 8×8=18, 9×9=18, 19×19=72, hex=96; for 3p: 8×8=24, 19×19=96, hex=128
        rings_per_player = {8: 18, 9: 18, 19: 72, 13: 96}.get(board_size, 18)
