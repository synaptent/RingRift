...
from .gpu_board_encoding import GPUBoardEncodingMixin
...
from .gpu_persona_mixin import GPUPersonaMixin
from .gpu_runner_reporting import GPURunnerReportingMixin
...
from .gpu_validation_mixin import GPUValidationMixin
...
class ParallelGameRunner(
    GPUBoardEncodingMixin,
    GPURunnerReportingMixin,
    GPUValidationMixin,
    GPUPersonaMixin,
):
