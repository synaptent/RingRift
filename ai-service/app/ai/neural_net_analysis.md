...
1.  **Integration**:
    - The `NeuralNetAI` class is exposed via the `ai-service/app/ai/neural_net/` package facade, with the archived compatibility implementation still routed through `app/ai/_neural_net_legacy.py`.
