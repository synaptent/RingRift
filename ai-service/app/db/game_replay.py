...
class GameReplayDB:
    ...
    def _auto_inject_before_move(self, state: GameState, next_move: Move) -> GameState:
        ...
        **DEPRECATED**: This method delegates to app.rules.legacy.replay_phase_injection.
        It violates RR-CANON-R075 (no silent phase fixes).

        See app.rules.legacy.replay_phase_injection.auto_inject_before_move for details.
        """
    ...
    def _auto_inject_no_action_moves(self, state: GameState) -> GameState:
        ...
        **DEPRECATED**: This method delegates to app.rules.legacy.replay_phase_injection.
        ...
        See app.rules.legacy.replay_phase_injection.auto_inject_no_action_moves for details.
        """
    ...
    def query_games(
        ...
        exclude_non_canonical: bool = True,
    ) -> list[dict]:
        ...
        Args:
            ...
            exclude_non_canonical: If True (default), exclude games with
                parity_status='non_canonical_history'. These are games
                generated by pre-canonical engines that don't match the
    ...
    def _finalize_game_conn(
        ...
        if existing:
            ...
            parity_status = metadata.get("parity_status", "pending")
            parity_checked_at = metadata.get("parity_checked_at")
            parity_divergence_move = metadata.get("parity_divergence_move")
            conn.execute(
                """
                UPDATE games SET
                    completed_at = ?,
            ...
            conn.execute(
                ...
                (game_id, board_type, num_players, rng_seed, created_at, completed_at,
                 ...
                 opponent_type, opponent_model_id, parity_status,
                 parity_checked_at, parity_divergence_move)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
                    game_id,
