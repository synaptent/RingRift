...
try:
    ...
    HEARTBEAT_TIMEOUT_SECONDS = HeartbeatDefaults.TIMEOUT  # 90s, not 60s
    ...
    HEARTBEAT_TIMEOUT_SECONDS = 90  # Fixed: was 60s, now matches HeartbeatDefaults.TIMEOUT
    ...
    def emit_health_event(self, health: CoordinatorHealth) -> None:
        ...
        try:
            ...
            try:
                ...
                fire_and_forget(
                    publish(event_type, payload, source="cross_coordinator_health"),
                    name="orchestrator_health_event",
                )
            except RuntimeError:
                publish_sync(event_type, payload, source="cross_coordinator_health")
