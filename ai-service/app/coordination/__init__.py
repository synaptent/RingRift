...
from app.coordination.unified_health_manager import (
    ...
    JobHealthState,
    NodeHealthState,
    # New system health types (December 2025 - consolidated from system_health_monitor.py)
    PipelineState,
    RecoveryAction,
    RecoveryAttempt,
    RecoveryConfig,
    ...
    get_health_manager,
    # New system health functions (December 2025 - consolidated from system_health_monitor.py)
