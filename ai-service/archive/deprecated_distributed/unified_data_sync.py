"""
ARCHIVED MODULE - DO NOT USE FOR NEW CODE

This module was archived on December 26, 2025 and will be removed in Q2 2026.

Archive Location: archive/deprecated_distributed/unified_data_sync.py
Original Location: app/distributed/unified_data_sync.py

Why Archived:
    Monolithic 2170-line module that tightly coupled transport logic, manifest
    management, WAL, deduplication, quality extraction, and aggregation.
    Difficult to test, extend, and maintain.

What Replaced It:
    - AutoSyncDaemon (app/coordination/auto_sync_daemon.py) - Primary replacement
    - SyncCoordinator (app/distributed/sync_coordinator.py) - Direct sync API
    - SyncFacade (app/coordination/sync_facade.py) - Simplified interface

Migration Guide: See archive/deprecated_distributed/README.md
