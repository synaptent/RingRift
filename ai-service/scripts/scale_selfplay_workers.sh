...
# Max moves - must be high enough for all board types to complete
# Hex boards need 2000-4000 moves, square boards need less
# Using safe defaults that work for all boards
MAX_MOVES_2P=${SELFPLAY_MAX_MOVES_2P:-2000}
MAX_MOVES_3P=${SELFPLAY_MAX_MOVES_3P:-3000}
MAX_MOVES_4P=${SELFPLAY_MAX_MOVES_4P:-4000}
