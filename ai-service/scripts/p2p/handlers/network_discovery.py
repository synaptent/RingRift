...
try:
    ...
    PEER_TIMEOUT = LoopTimeouts.PEER_DEAD_TIMEOUT  # 150.0 seconds (matches app/p2p/constants.py)
except ImportError:
    PEER_TIMEOUT = 150.0  # Fallback - peer considered dead after this (matches PEER_TIMEOUT=150s)
