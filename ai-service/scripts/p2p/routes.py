...
CORE_ROUTES = [
    ...
    Route("GET", "/stability", "handle_stability"),  # Jan 22, 2026: P2P Self-Healing Architecture - unified stability endpoint
...
WORK_QUEUE_ROUTES = [
    ...
    Route("POST", "/work/flush_stale", "handle_work_flush_stale"),  # Mar 2026: Archive failed/timeout items
