...
try:
    ...
    DISK_CLEANUP_THRESHOLD = DISK_PRODUCTION_HALT_PERCENT  # 93
    DISK_WARNING_THRESHOLD = DISK_PRODUCTION_HALT_PERCENT - 5  # 88
    DISK_CRITICAL_THRESHOLD = DISK_CRITICAL_PERCENT  # 96
except ImportError:
    DISK_CLEANUP_THRESHOLD = 93
