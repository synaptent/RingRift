...
PY
  ...
  ssh -n "${SSH_OPTS[@]}" "ubuntu@${ip}" 'mkdir -p ~/ringrift/ai-service/logs ~/ringrift/ai-service/logs/selfplay ~/ringrift/ai-service/p2p_state && sudo chown -R ubuntu:ubuntu ~/ringrift/ai-service/logs ~/ringrift/ai-service/p2p_state'
