...
> - For current AI architecture and assessment, pair this with [`AI_ARCHITECTURE.md`](../docs/architecture/AI_ARCHITECTURE.md), the technical assessment in [`AI_ASSESSMENT_REPORT.md`](./AI_ASSESSMENT_REPORT.md), and the training/meta docs [`docs/ai/AI_TRAINING_AND_DATASETS.md`](../docs/ai/AI_TRAINING_AND_DATASETS.md) and [`docs/ai/AI_TRAINING_PREPARATION_GUIDE.md`](../docs/ai/AI_TRAINING_PREPARATION_GUIDE.md).
> - Related docs: parity and invariants meta-docs such as [`docs/rules/PYTHON_PARITY_REQUIREMENTS.md`](../docs/rules/PYTHON_PARITY_REQUIREMENTS.md), [`docs/testing/STRICT_INVARIANT_SOAKS.md`](../docs/testing/STRICT_INVARIANT_SOAKS.md), [`tests/TEST_SUITE_PARITY_PLAN.md`](../tests/TEST_SUITE_PARITY_PLAN.md), [`docs/rules/PARITY_SEED_TRIAGE.md`](../docs/rules/PARITY_SEED_TRIAGE.md), and the historical plan in [`archive/AI_IMPROVEMENT_PLAN.md`](../archive/AI_IMPROVEMENT_PLAN.md).
...
2. ~~**Extended tournament**~~ ✅ RESOLVED (`scripts/run_distributed_tournament.py`, `scripts/run_tournament.py crossboard`)
3. ~~**Cross-board validation**~~ ✅ RESOLVED (rank-consistency summary via `scripts/run_tournament.py crossboard`)
