...
- **Looking for Specific Answers**: Check the [FAQ](#154-frequently-asked-questions) or use the [Quick Reference Guide](#19-quick-reference-guide)
...
3. Move to the 19×19 board once you're comfortable with the core dynamics
...
> **⚠️ Viewing Note**: This document contains Mermaid diagrams which require a compatible viewer.
>
> **Recommended Viewers for Mermaid Diagrams:**
>
> - **GitHub** web interface renders diagrams natively
> - **VS Code** with either "Markdown Preview Enhanced" or "Markdown All in One" extensions
> - **Typora** Markdown editor (supports Mermaid natively)
> - **Obsidian** note-taking app
> - **Mermaid Live Editor**: <https://mermaid.live> (for viewing just the diagrams)
> - **HackMD** or **GitLab** web interfaces
...
- [RingRift Complete Rules](#ringrift-complete-rules)
  ...
  - [2. Simplified 8×8 Version](#2-simplified-88-version)
  ...
  - [3. Core Game Elements (19x19 Full Version)](#3-core-game-elements-19x19-full-version)
    - [3.1 The Board (19x19 Full Version)](#31-the-board-19x19-full-version)
    - [3.2 Player Pieces (19x19 Full Version)](#32-player-pieces-19x19-full-version)
      - [3.2.1 Rings (19x19 Full Version)](#321-rings-19x19-full-version)
      - [3.2.2 Markers (19x19 Full Version)](#322-markers-19x19-full-version)
  - [4. Turn Sequence (19x19 Full Version)](#4-turn-sequence-19x19-full-version)
  ...
  - [8. Non-Capture Movement (19x19 Full Version)](#8-non-capture-movement-19x19-full-version)
    - [8.1 Basic Movement Rules(19x19 Full Version)](#81-basic-movement-rules19x19-full-version)
    - [8.2 Minimum Distance Requirements (19x19 Full Version)](#82-minimum-distance-requirements-19x19-full-version)
  ...
  - [15. FAQ \& CLARIFICATIONS (All Versions Unless Specified)](#15-faq--clarifications-all-versions-unless-specified)
    ...
    - [15.4 Frequently Asked Questions](#154-frequently-asked-questions)
      ...
      - [Q14: When is Overtaking capture optional and when is it mandatory?](#q14-when-is-overtaking-capture-optional-and-when-is-it-mandatory)
  ...
  - [16. Simplified 8×8 Version and Comparison with Full Version](#16-simplified-88-version-and-comparison-with-full-version)
    ...
    - [16.8 Full 19×19 Version](#168-full-1919-version)
      - [16.8.1 Major Differences from 8×8](#1681-major-differences-from-88)
      - [16.8.2 Components \& Setup (19×19)](#1682-components--setup-1919)
      - [16.8.3 Turn Sequence Summary (Full)](#1683-turn-sequence-summary-full)
      - [16.8.4 Detailed Rules](#1684-detailed-rules)
        - [16.8.4.1 Movement \& Adjacency](#16841-movement--adjacency)
        - [16.8.4.2 Overtaking vs. Elimination](#16842-overtaking-vs-elimination)
        - [16.8.4.3 Lines \& Collapses (19x19 / Hexagonal Focus)](#16843-lines--collapses-19x19--hexagonal-focus)
        - [16.8.4.4 Territory Disconnection](#16844-territory-disconnection)
        - [16.8.4.5 Victory Conditions \& Tiebreakers](#16845-victory-conditions--tiebreakers)
      - [16.8.5 Quick Start Examples (19×19)](#1685-quick-start-examples-1919)
      - [16.8.6 Territory Disconnection Example (19×19 Using Von Neumann/4-Direction Adjacency)](#1686-territory-disconnection-example-1919-using-von-neumann4-direction-adjacency)
      - [16.8.7 Victory Through Territory Control](#1687-victory-through-territory-control)
      - [16.8.8 Chain Reaction Example](#1688-chain-reaction-example)
    - [16.9 Comparing the Three Editions](#169-comparing-the-three-editions)
    - [16.10 Closing Note](#1610-closing-note)
...
> - Sections marked "Square Grid Versions" apply to both 8x8 and 19x19.
...
> - For a detailed comparison, see [Section 16.8](#168-comparing-the-three-editions).

#### 1.2.1 Version Comparison Summary

| Feature                     | 19×19 Full Version                          | 8×8 Simplified Version                            | Hexagonal Version                               |
|-----------------------------|---------------------------------------------|---------------------------------------------------|-------------------------------------------------|
| Board Size                  | 361 spaces (19×19)                          | 64 spaces (8×8)                                   | 331 spaces (11 per side)                        |
| Rings per Player            | 36 rings                                    | 18 rings                                          | 36 rings                                        |
...
We recommend beginning with the **8×8 version** - it has simpler rules but preserves all core mechanics. The full 19×19 version and full hexagonal version add strategic depth once you're comfortable with the basics.
...
1. **PLACE** (Optional - Unless Board is Empty or You Control No Rings / Stacks on the Board):
   - If you have rings in hand, you may place one on an empty space or on any stack
   - Placing on a stack immediately gives you control of that stack

2. **MOVE** (Required):
   - Move the newly placed ring/stack (or any ring/stack you control, if you didn't place)
   - Movement must be in a straight line (orthogonal or diagonal)
   - Move at least as many spaces as the stack's height
   - Leave a marker of your color on the starting space
   - Can be a capturing move or a non capturing move

3. **CAPTURE** (As Available):
   - After an initial non-capturing move, or as part of the initial move, you may jump over opponent stacks to Overtake (capture) their top ring
   - Add Overtaken (captured) rings to the bottom of your stack
   - Once you start an Overtaking capture, chain capturing is mandatory

4. **TERRITORY** (Automatic):
   - Lines of markers (4+ for 8x8, 5+ for 19x19/Hex) of your color convert to permanent claimed territory.
...
- **Strategic Alliances**: Players naturally form temporary alliances against the leader
- **Chain Reactions**: One move can trigger dramatic territory cascades

#### Quick Strategy Tips
- Balance tall cap stacks (powerful but less mobile) with multiple smaller stacks
...
For full details, continue reading or skip ahead to [Section 2](#2-simplified-88-version) for the simplified version rules.

## 2. Simplified 8×8 Version
...
- **Von Neumann Neighborhood**: Only the 4 orthogonally adjacent spaces (up, down, left, right). Used for territory connectivity checks in **both 8x8 and 19x19** square versions.
...
## 3. Core Game Elements (19x19 Full Version)

### 3.1 The Board (19x19 Full Version)
...
- Territory Connectivity: Uses 4-direction adjacency (Von Neumann neighborhood - orthogonal only). This distinction is crucial for strategic depth.
 • **Space States**:
...
### 3.2 Player Pieces (19x19 Full Version)
...
#### 3.2.2 Markers (19x19 Full Version)

 • Quantity: 361 markers (one per board space)
 • Design:
 • Physical Form: A rounded cubic die with six circular faces produced by intersecting a cube with a truncating sphere and three orthogonal cylinders
 • Face Types:
...
## 4. Turn Sequence (19x19 Full Version)
...
- **Subsequent Move Prerequisite:** Before a placement is considered valid, it must be confirmed that the resulting stack (at its new position and with its potentially new height) would have at least one legal move available according to the standard movement rules (Section 8 / Section 16.7.4.1). This check is performed on the hypothetical state *after* placement. If no legal move would be possible, the placement itself is illegal and cannot be chosen. For example, placing a ring to create a stack of height 9 on an 8x8 board is illegal anywhere, as no subsequent move is possible. This check applies to both placing on empty spaces and placing on top of existing stacks.
 • **Edge Cases**:
...
- Must land on first empty space after markers (non-capture moves only)
- Opponent markers flip to your color
...
### 4.5 Post-Movement Processing
 ...
 • **After movement and any captures are complete (and after any same-color marker removal upon landing), check for**:
   ...
   1. **Line formations (4+ for 8x8, 5+ for 19x19/Hex)**
      - Process each line one at a time, with moving player selecting which line to process first.
      - Determine required line length (4 for 8x8, 5 for 19x19/Hex).
      - For each line:
...
### 5.1 Stack Height
 ...
 • **Definition**: The total number of rings in the stack, regardless of color
 • **Order**: The sequence of rings is maintained when stacking
 • **Additions**: Newly captured overtaken rings always go to the bottom
 • **Impact**: Stack height directly affects minimum movement distance requirements

### 5.2 Cap Height

   • **Definition**: The cap height is the number of consecutive rings of the controlling color (top color) from the top downward
  • **Strategic Importance**: Cap height determines ability to capture other stacks - you can only capture stacks with cap heights less than or equal to your own
  • **Examples**:
    • A stack with three blue rings atop one red ring has a cap height of 3
    • A stack with two blue rings, one red, then one blue has a cap height of 2
...
## 8. Non-Capture Movement (19x19 Full Version)

### 8.1 Basic Movement Rules(19x19 Full Version)
...
### 8.2 Minimum Distance Requirements (19x19 Full Version)

#### Key Movement Rules (19x19 Full Version)

 • **Basic Distance Rule**: Must travel at least as many spaces as the stack height
 • **Counting Method**: Distance is counted before any marker flipping/collapsing occurs
 • **Valid Count**: Both empty spaces and markers count toward distance requirement
 • **Extended Movement**: Can move further than minimum if no markers are encountered
 • **Marker Interaction & Landing (All Versions):** When moving over markers (friendly or opponent) during a non-capture move, you may land on **any valid space beyond the markers** along the line of travel, provided:
...
*These examples illustrate three key movement scenarios:*

*1. With no markers (Example 1): A stack with height 3 must move at least 3 spaces, with any non collapsed unoccupied space ≥3 spaces away being a valid landing point.*
...
- Count toward minimum distance requirement
 ...
 - If a move or overtaking capture segment concludes by landing on a space occupied by a single marker of the moving stack's color (and all other movement conditions like distance and path legality are met), first the marker occupyng that space is removed from the board, and then next the stack lands on that space. This marker removal occurs immediately and *before* the Post-Movement Processing phase (checking for lines and disconnections).
...
### 9.2  Elimination Captures (Rings Permanently Leave Play)
   ...
   1. **Line Formation:** When a player forms a straight line of the required number of consecutive markers (**4+ for 8x8**, **5+ for 19x19/Hex**), they must Eliminate one of their rings or the entire cap of one of their controlled ring stacks for each distinct line formed (unless choosing Option 2 for longer lines).
...
### 10.2 Executing an Overtaking Capture
 ...
 • **Landing Flexibility (All Versions):** Unlike non-capture moves in the 19x19/Hex versions, during an Overtaking capture, you may land on **any valid space beyond the captured stack** along the line of travel, provided:
...
### 10.3 Chain Overtaking
 ...
 • Once an Overtaking capture begins, continued chain Overtaking (capturing) is mandatory
 • **Mandatory Continuation Rule**: At each landing position after a capture, IF any legal capture segment exists from that position, you MUST perform one of them (mandatory). However, you get to choose WHICH one to perform (strategic choice).
 • **Strategic Chain-Ending**: You can strategically choose a capture that leads to a position with NO further legal captures, thus ending the mandatory chain - even if other capture choices from your current position would have led to positions with more captures available.
    - This is an intentional tactical element that allows players to avoid unfavorable forced sequences
    - Example: From position X, you can capture in direction A (leading to 4 more forced captures), direction B (leading to 2 more), or direction C (leading to no more captures). You may choose C to end the chain.
 • Can change direction between captures within the grid's movement axes
 • Can capture from same stack multiple times (through reversal or cyclic patterns)
 • Chain captures must continue even if they would:
    - Result in the capturing player having no rings/stacks left
    - Create lines of required length (4+ or 5+) markers
    - Create disconnected regions
    - Result in reaching the victory threshold (>50% of total rings)
    - Reverse any of the temporarily achieved events above by continuing
...
### 10.4 Capture Patterns
 ...
 • Chain captures must eventually end due to:
    - Collapsed spaces blocking paths
    - Increasing stack height requirements
    - No legal captures remaining
...
### 11.1 Line Formation Rules
 ...
 • A line is formed when the required number of consecutive markers of the same color are aligned in a straight line:
    - **8x8 Version:** 4 or more markers.
    - **19x19 & Hexagonal Versions:** 5 or more markers.
...
### 11.2 Collapse Process
 ...
 1. **For lines of exactly the required length (4 for 8x8, 5 for 19x19/Hex):**
 ...
 2. **For lines longer than the required length (5+ for 8x8, 6+ for 19x19/Hex):** You have two options:
    ...
    - **Option 2:** Replace only the required number (4 or 5) of *any* consecutive markers of your choice within the line with collapsed spaces of your color WITHOUT eliminating any of your rings or any caps of your ring stacks. You decide which specific consecutive segment to collapse.
...
> **Strategic Impact**: This graduated system creates interesting decisions with longer lines - choosing between maximum territory control (Option 1) or ring preservation (Option 2).
 ...
 • Collapsed spaces:
    - Are permanently claimed territory
    - Cannot be moved through or occupied
    - Count toward territory control tiebreakers

 • Important Notes:
    - For lines of the exact required length, you must process each line in its full extent (no partial collapses).
    - For longer lines, choosing Option 2, you decide which consecutive segment (of length 4 or 5) to collapse.
    - You choose which of your rings/stacks to Eliminate when required (Option 1 or exact length lines). If eliminating from a stack, the entire cap is removed.
    - Collapsed spaces cannot form part of future lines.
    - After each line collapse, check for any remaining valid lines.

```mermaid
graph TD
   subgraph "Graduated Line Reward Example - 5 Markers in a Row (8x8 Version)"
       ...
       NOTE["Blue player has 5 markers in a row (8x8 board). Required length is 4. Must choose between two options."]
...
*This diagram illustrates the strategic choice offered by the Graduated Line Rewards rule on an 8x8 board. When forming a line of 5 consecutive markers (which is longer than the required 4), Blue can choose to either collapse the entire line and eliminate one of their rings (Option 1, maximizing territory control), or collapse only 4 consecutive markers without eliminating any rings (Option 2, preserving rings for future moves).*
...
graph TD
    ...
    note["Assuming 19x19/Hex (requires 5). Since intersections are now collapsed spaces, the other two lines no longer have 5+ markers in a row and are invalid for processing."]
    
    AFTER1 --- note
```

*In this example (assuming 19x19/Hex), Blue forms three lines of 5 markers (horizontal, diagonal up and diagonal down), all sharing intersections. When the player chooses to process the horizontal line first, it collapses to Blue's color. The other two potential lines no longer meet the 5+ consecutive marker requirement because their intersections are now collapsed spaces. This demonstrates why the order of processing lines can be strategically important.*

. Area Disconnection & Collapse (Square & Hexagonal Versions)

### 12.1 Territory Rules

#### Core Territory Concepts

 • **Conne## 12ctivity Definition**: Territory connectivity uses the appropriate adjacency rule for the game version:
    - **Square Boards (19x19 and 8x8 Versions)**: Von Neumann (4-direction orthogonal adjacency - up, down, left, right).
    - **Hexagonal Version**: Hexagonal (6-direction adjacency).
 ...
 • **Disconnection Barriers**: Regions can be disconnected by barriers formed by:
    - Collapsed spaces (of any color).
    - A continuous border formed *only* by markers of **one single player's color**.
    - Board edges.
    - Any combination of the above. (Clarification: *All non-collapsed marker portions* of a disconnecting border must belong to the *same single player*. A border consisting of a player's markers combined with collapsed spaces of any color - including somer or all of other colors - still qualifies as a disconnecting border).
...
> **Cross-Reference**: See [FAQ Q15](#q15-how-is-a-region-determined-to-be-surrounded-or-disconnected-version-specific) for detailed criteria and [Section 16.7.6](#1676-territory-disconnection-example-19x19-using-von-neumann4-direction-adjacency) for examples.
...
*This diagram illustrates how territory connectivity works in RingRift:*
*1. Spaces are considered connected only through orthogonal (not diagonal) adjacency*
*2. Collapsed spaces act as barriers that disconnect regions*
*3. A continuous border of markers of a single color also disconnects regions*
*4. For a region to be processed as "disconnected", it must also lack representation from at least one player color that has rings on the board*

### 12.2 Disconnection Process

 • A region becomes disconnected when:

 1. **Physical Disconnection:** It is completely surrounded (using the version's territory adjacency rule) by a barrier consisting of collapsed spaces (any color), board edges, and/or a continuous border formed *only* by markers of **one single player's color**. (Clarification: *All non-collapsed marker portions* of the border must belong to the *same single player*).
 ...
 • **Self-Elimination Prerequisite Check:** Before processing each disconnected region, check whether you have at least one ring or stack cap under your control *outside that specific region*. 
    - Each ring or stack cap (regardless of cap height) allows you to process exactly ONE region.
    - A cap of any height (1, 2, 5, etc.) counts as "one cap" for this check.
    - "Outside that specific region" means outside the particular region you are about to process, NOT outside all potentially disconnected regions.
    - **Sequential Processing**: If multiple regions disconnect, check and process them one at a time. After processing each region and performing the mandatory self-elimination, recheck before processing the next region.
 • If this check fails (you have no ring/cap outside the region):
    - Processing this disconnection is **illegal**
    - The region remains disconnected but unprocessed
    - No rings are eliminated from that region
 • If the check passes:
    - You collapse the region and its single-color marker border (if applicable) to your color
    - Then, you eliminate all rings within the now-collapsed region (all colors)
    - Finally, you *must* eliminate one of your remaining controlled rings OR the entire cap of one of your remaining controlled stacks that is outside the just-processed region
 • All eliminated rings (those inside the region + your self-eliminated one) count toward your victory total.
 • Important Notes:
    ...
    - Moving player (you) chooses which of their (your) remaining rings or which stack's entire cap to Eliminate for each region. If you only have one remaining ring or ring stack cap under your control, you must eliminate it. If you have none to eliminate, then you are not allowed to process the disconnected region (meaning to collapse it and claim it as your territory).
...
### 12.3 Chain Reactions
 ...
 • Important Notes:
    - If the board splits into multiple regions that each lack a color, all such regions must be processed sequentially before proceeding
    - For each potential disconnected region, the moving player must first check the **Self-Elimination Prerequisite** (see 12.2). Only regions that pass this check can be processed.
    - If multiple regions pass the prerequisite check, the moving player processes them one by one, choosing the order. For each processed region: eliminate internal rings, collapse the area, then perform the mandatory self-elimination.
    - Then, rings and stacks in all disconnected regions are Eliminated and claimed by the moving player
    - Choice of ring elimination by the player moving may also affect whether other regions become disconnected and also need to be processed
    - Chain reactions can lead to dramatic board changes and often result in victory
    - Process all disconnected regions you are allowed to, before checking victory conditions
    - If victory conditions are not met, play passes to the next player after the area disconnection phase has been completed
...
### 13.1 Ring Elimination Victory (Primary Victory Path)
 ...
 • Threshold is >50% of the total rings initially in play for the chosen version and player count:
    - **8x8 Version:** >18 (2p), >27 (3p)
    - **19x19 / Hexagonal Versions:** >36 (2p), >54 (3p), >72 (4p)
 • What Counts Toward Victory:
 • Rings Eliminated through line formations (your own rings removed when collapsing lines)
 • Rings Eliminated through territory control (your own rings removed when claiming areas)
 • Rings Eliminated from disconnected regions (both your rings and opponent rings in disconnected areas)
...
### 13.2 Territory Victory (Primary Victory Path)
 ...
 • Thresholds: >180 spaces (19x19), >165 spaces (Hexagonal), >32 spaces (8x8).
...
### 13.3 Last Player Standing
 ...
 • Victory Condition:
 • Win by being the only player able to make legal moves - if the other two players lose control of all rings and stacks and have none in hand, or otherwise cannot move on their turns, but you can move on your turn, and then if they still cannot move on their subsequent turns, then you win
 • This occurs for example when all opponents have no rings/stacks on board AND no rings in hand, or when their rings/stacks are completely blocked from movement, e.g. due to stack height movement requirements
 • Player Status Details:
 • A player is only considered eliminated when they have:
    - No rings or stacks on the board, or when their rings/stacks are blocked from movement, AND
    - No rings remaining in hand
 • Important: A player with rings in hand but no board presence is still active if legal placements exist
 • Recovery Possibility: An eliminated player can return to play if they gain control of a multicolored stack through its top ring becoming their color
...
1. Marker Placement
   ...
   • Create potential lines (**4+ for 8x8**, **5+ for 19x19/Hex**)
...
2. Graduated Line Rewards Strategy
   • With lines longer than required (**5+ for 8x8**, **6+ for 19x19/Hex**), evaluate whether to:
     - Maximize territory control (Option 1: collapse all markers and eliminate a ring/cap)
     - Preserve rings for future plays (Option 2: collapse only the required number (4 or 5) of *any* consecutive markers)
   • Use Option 1 when:
   ...
   • Try to form lines longer than the minimum required (**4 for 8x8**, **5 for 19x19/Hex**) to gain this strategic flexibility.
...
>
> Where rules differ between versions (8×8 vs. 19×19) or player counts (2, 3, or 4), this is explicitly indicated in headings or explained in the text. For comprehensive differences between game versions, refer to Section 16.8 which provides detailed comparisons.
...
**For 8×8 Version Only**:
 • *(Rule Unified)*: The rule is now consistent with the 19x19 and Hexagonal versions as described above.
...
**For 19×19 / Hexagonal / 8x8 Versions**:
...
2. **For lines longer than the required length (5+ for 8x8, 6+ for 19x19/Hex):** You have a choice:
   ...
   - **Option 2:** Collapse only the required number (4 or 5) of *any* consecutive markers of your choice within the line WITHOUT eliminating any of your rings.
...
A9: The chain Overtaking capture sequence must still be completed, even if it creates a situation where no further legal moves would be possible (e.g., by creating collapsed spaces that block all paths). Chain captures cannot be ended voluntarily if any legal capture segments remain available from the current position.
...
A11: If no legal moves or legal ring placements are possible (e.g., the remaining stacks on the board are too tall with or without ring placement onto them, and have no legal movements or captures in either case, hence rings cannot be placed on them), any rings remaining in players' hands are counted as Eliminated rings for those players. The game ends, and the winner is determined using the standard tiebreakers (Section 13.4). These rings in hand explicitly count towards the "Most Eliminated rings" tiebreaker total.

#### Q12: What happens if a chain Overtaking capture would eliminate all my rings?

A12: The chain Overtaking capture sequence must still be completed, even if it would result in you having no rings/stacks left (due to creating lines or disconnected regions that require removal). All turn phases must be completed in order, regardless of the outcome.
...
• Von Neumann neighborhood: Only includes the 4 orthogonally adjacent spaces. Used for:
- Territory Connectivity checks (19×19 version only)
- Territory Connectivity checks (**both 8x8 and 19x19** square versions use Von Neumann).
...
#### Q14: When is Overtaking capture optional and when is it mandatory?

A14: After an initial non-capturing move, if a legal Overtaking capture is available, you may choose whether or not to initiate the capture phase. However, once you begin an Overtaking sequence, making subsequent chain Overtaking capture jump segments are mandatory as long as legal additional Overtaking capture jump segments exist for the capturing ring stack from the landing space. While you can choose which Overtaking capture jump segment to make when multiple options exist, you cannot voluntarily end the sequence if any legal Overtaking capture jump segments remain (see Section 10.3 for details on Chain Overtaking).
...
1.  **Physical Disconnection:** The region must be cut off from the rest of the board using the appropriate territory adjacency rule for the version (**Von Neumann for 8x8 and 19x19**, Hexagonal for Hex). This barrier can be formed by collapsed spaces (any color), board edges, and/or a continuous border formed *only* by markers of **one single player's color** (all non-collapsed marker portions of the border must belong to the same single player).
2.  **Color Representation:** The region must lack representation from at least one player color that currently has rings **on the board**.
    ...
    - **General Rule:** If the set of players controlling stacks *inside* the region is a proper subset of the set of players with stacks *anywhere on the board*, the region is disconnected.
    • **Examples (Original):**
    ...
    • 1 player with rings on board: Only regions with *no* rings/stacks are disconnected.
...
When a region becomes disconnected:
• All rings within the region are Eliminated from play. For example, if rings controlled by three different players are present on the board, any region that is orthogonally disconnected from the rest of the board and contains only rings/stacks controlled by only one color or only two colors, is considered surrounded/disconnected, and all rings in all stacks of all colors within that region are Eliminated by the player who is moving and who caused the region to become disconnected.
• **Self-Elimination Prerequisite Check:** *Before* processing, perform a *hypothetical* check: If all rings within the region were eliminated, would the moving player still have at least one ring/cap left elsewhere on the board? If not, the region cannot be processed.
• If the check passes, the player collapses the region (and any single-color border markers) to their color, eliminates all internal rings (regardless of color), and *then* performs the mandatory self-elimination of one of their remaining rings/caps.
• All eliminated rings (internal + self-eliminated) count towards the moving player's victory total.
...
• **8x8:** >18 (2p), >27 (3p)
• **19x19 / Hexagonal:** >36 (2p), >54 (3p), >72 (4p)
...
| Territory Adjacency         | Von Neumann (4-direction)                   | Von Neumann (4-direction)                         | Hexagonal (6-direction)                         |
| Movement Landing Rule       | Min distance, any valid space beyond markers    | Min distance, any valid space beyond markers      | Min distance, any valid space beyond markers    |
| Capture Landing Rule        | Min distance, any valid space beyond target     | Min distance, any valid space beyond target       | Min distance, any valid space beyond target     |
| Complexity                  | High                                        | Low                                               | High                                            |
### 16.1 Visual Summary of Territory Disconnection Rules

```
```
┌───────────────── 19×19 VERSION ─────────────────┐   ┌───────────────── 8×8 VERSION ─────────────────┐
│      Von Neumann (4-Direction) Connectivity     │   │     Von Neumann (4-Direction) Connectivity      │
│      (Applies to 19x19 and 8x8)                 │   │     (Applies to 19x19 and 8x8)                  │
│         A   A   A                               │   │         A   A   A                             │
│                                                 │   │                                               │
│       A           A                             │   │       A           A                           │
│                                                 │   │                                               │
...
│                                                 │   │                                               │
│  LEGEND:                                        │   │  LEGEND:                                      │
│  A = Player A's marker                          │   │  A = Player A's marker                        │
│  B = Player B's ring                            │   │  B = Player B's ring                          │
│                                                 │   │                                               │
│  REGION STATUS:                                 │   │  REGION STATUS:                               │
│  B ring IS DISCONNECTED because it can only     │   │  B ring IS DISCONNECTED because it can only   │
│  connect orthogonally (Von Neumann)             │   │  connect orthogonally (Von Neumann)           │
│  and all orthogonal paths are blocked.          │   │  and all orthogonal paths are blocked.        │
│                                                 │   │                                               │
│  If this region lacks any color present         │   │  If this region lacks any color present       │
│  elsewhere on the board, it can be claimed      │   │  elsewhere on the board, it can be claimed.   │
│  by the player who caused the disconnection.    │   │                                               │
└─────────────────────────────────────────────────┘   └───────────────────────────────────────────────┘
```
...
4. Check for lines of **4+** markers → collapse → eliminate one ring or cap per line (with graduated reward for 5+).
...
- Control >50% of board as collapsed territory (>181 spaces in 19×19, >33 in 8×8)
- Be the last player able to make legal moves

### 16.2 Overview of Simplifications
 ...
 • Lines of **4+** markers can be formed in both orthogonal and diagonal directions (Moore neighborhood).
 • Territory disconnection uses **Von Neumann neighborhood (4-direction)** adjacency, consistent with the 19x19 version.
 
Despite these changes, we preserve:
 • Overtaking vs. Elimination captures, though slightly simplified.
 • Line-of-**4** collapses, territory disconnection, chain Overtaking captures, etc.

### 16.3 Components & Setup (8×8)
...
### 16.4 Key Rules & Turn Flow (Simplified)
...
Turn Flow Summary:
 ...
 5. Check Lines of **4** (orthogonal or diagonal). Collapse them, Eliminate one ring or cap of one controlled ring stack for each (with graduated reward for 5+).
...
#### 16.4.1 Movement (8×8 Version's Simplified Rules)
...
#### 16.4.2 Overtaking (Stack Capture)
...
#### 16.4.3 Elimination Captures

 • Occurs only from:

 1. **Line-of-4 (orthogonal or diagonal):**
    - **For exactly 4 consecutive markers:** You must Eliminate one of your rings or the cap of one of your controlled ring stacks per line. Collapse all 4 markers.
    - **For 5+ consecutive markers:** You may choose either:
      - **Option 1:** Eliminate one of your rings/caps AND collapse the entire line, OR
      - **Option 2:** Collapse only 4 consecutive markers of your choice within the line WITHOUT eliminating any rings.
    - This "Graduated Line Rewards" system (starting at 5+ markers for 8x8) adds strategic depth.
...
*This example illustrates basic movement. The ring only needs to satisfy the minimum distance requirement (stack height 1 = move at least 1 space). Landing after markers follows the unified rule (can land on any valid space beyond markers meeting the distance requirement).*

### 16.7 Territory Disconnection Example (8×8)
...
BEFORE PLAYER A'S TURN:                      AFTER PLAYER A'S TURN:
 ...
 4 |A|A|A|A|A| | | |                          4 |A|A|A|A|A| | | |   * = A's self-eliminated ring
   +-+-+-+-+-+-+-+-+                            +-+-+-+-+-+-+-+-+
...
### 16.8 Full 19×19 Version

Below are the 19x19 full rules in comparison with the simplified 8x8 version. Key differences:
 • Board: 19×19 intersections, with Moore adjacency for movement & line-of-5, but Von Neumann adjacency for territory disconnection.
 ...
 • Victory: Reach or surpass 72 Eliminated rings (≥72), or last standing, or stalemate tiebreak.

#### 16.8.1 Major Differences from 8×8

 1. **Dual Adjacency Systems (Same as 8x8):**
    • Movement + Lines: 8-direction (Moore).
    • Territory Disconnection: 4-direction (Von Neumann).
 • Line Formation: Requires **5+** markers.
 2. Minimum-Distance Movement: Must move at least as many spaces as your stack's height. When moving over markers, can land on any valid space beyond them meeting the distance requirement.
 3. Bigger Board = 361 spaces, and 36 rings per player (108 total).
...
#### 16.8.3 Turn Sequence Summary (Full)
...
Every Turn:
 ...
 5. Line-of-5 Check (Moore adjacency). Collapse lines → Eliminate rings (with graduated reward for 6+).
...
#### 16.8.4 Detailed Rules

##### 16.8.4.1 Movement & Adjacency
 ...
 Minimum Distance & Landing Rule In Detail (All Versions - Non-Capture):
  • Basic Requirements:
     - Must move at least as many spaces as your stack's total height.
     - Distance is counted before any marker flipping/collapsing occurs.
     - Both empty spaces and markers count toward the minimum distance.
  • Landing Options:
     - The landing space must be either **(a) empty** or **(b) occupied by a single marker of the moving stack's color**.
     - Landing on opponent markers or collapsed spaces is illegal.
  • Marker Interaction:
     - When markers (friendly or opponent) are encountered in your path:
        * You may land on **any valid space** (empty or same-color marker) beyond the markers, as long as the minimum distance requirement is met.
        * You are **not required to stop at the first** valid space after the markers.
     - If landing on a same-color marker, it is removed.
     - If no valid landing space beyond the markers satisfies the minimum distance, movement in that direction is invalid.
  • Examples:
     - Stack height 3: Must move at least 3 spaces to a valid landing spot.
     - Stack height 5 with markers: Must move at least 5 spaces, can land on any valid space (empty or own marker) beyond markers satisfying this distance.

##### 16.8.4.2 Overtaking vs. Elimination
...
Overtaking (Stack Capture)
 ...
 • Requirements:
    - Your stack's cap height must equal/exceed target's cap height
    - Must have clear line of sight and valid landing space
    - Must meet minimum distance requirement for your stack's height

Elimination Captures
 • Occurs via:

 1. **Line-of-5 (19x19/Hex):** Collapsing the line (with graduated reward for 6+), Eliminating one ring or the cap of one stack of your own per line (unless choosing Option 2 for 6+ lines).
...
Capture Type Trigger     Rings' Fate        Counts Toward 72+?
Overtaking  Jump over ring   Top ring added to your stack bottom   No (still on board)
Elimination  Lines/Disconnection  Rings physically removed from board   Yes

##### 16.8.4.3 Lines & Collapses (19x19 / Hexagonal Focus)

 *Note: The general rules for line formation and collapse, including the graduated rewards (Option 1 vs Option 2 for lines longer than required), are covered in Section 11. This section focuses specifically on the **5+ marker length requirement** for the 19x19 and Hexagonal versions.*
...
##### 16.8.4.4 Territory Disconnection
...
• If both conditions are met, that region collapses to your color, removing any rings inside (Elimination) plus forcing you to remove one ring or the cap of one of your controlled ring stacks for each region collapsed (after passing the self-elimination prerequisite check).
    - Process each disconnected region in its full extent.
    - Moving player chooses which of their rings/stack caps to Eliminate for each region.
    - After each region collapse and ring removal, check for new disconnected regions
    - All rings in the region are Eliminated regardless of their color or stack position
    - The player who caused the disconnection claims all Eliminated rings toward their victory total
    - Process all disconnected regions before checking victory conditions

##### 16.8.4.5 Victory Conditions & Tiebreakers
 ...
 • Important Notes:
    ...
    - Rings in hand that cannot be placed count as Eliminated rings in stalemate situations
    - A player with rings in hand but no board presence is still active if legal placements exist

#### 16.8.5 Quick Start Examples (19×19)

Scenario 1 - Basic Movement:
 • Initial State:
    - A places ring at (10, 10)
    - Must move it since it was just placed (height=1)
    - Two B-markers are on spaces (11, 11) and (12, 12)
 • Movement Details:
    - Moves diagonally up-right 3 spaces (since 3≥1)
    - Leaves A-marker behind at (10, 10)
    - Jumps over both B-markers, flipping them to A
    - Can land on (13, 13) or any further valid space along the path meeting the distance requirement. Let's assume it lands on (13, 13).
 • Movement is valid because:
    - Moved at least 1 space (minimum for height 1)
    - Landed on a valid space beyond markers satisfying minimum distance
    - Path was clear (no collapsed spaces or rings)

Scenario 2 - Capture Example:
 • Next Turn Setup for A:
    - B has a stack (height 2, cap height 1) at (14, 14)
    - B's stack has 1 ring as the cap and 1 of A's rings below
    - A's ring from previous turn is at (13, 13)
 • Capture Requirements:
    - A's cap height (1) must equal/exceed B's cap height (1)
    - Must have clear line of sight to B's stack
    - Must have valid landing space beyond B's stack
 • Capture Execution:
    - A jumps from (13, 13) over B's stack
    - Must move at least 1 space (A's height)
    - Lands on (15, 15), a valid space after B's stack meeting the distance requirement (capture landing allows flexibility).
    - Captures B's top ring, adding it under A's ring
    - A's stack now height 2 (A on top, B on bottom)
    - B's former stack is now a single ring belonging to A on (14,14)

Scenario 3 - Chain Capture with Territory Impact:
 • Continuing from Previous:
    - A's stack now height 2, cap 1 at (15, 15)
    - Another B stack (height 1) is at (16, 16)
    - A's single ring is at (14, 14)
    - A-markers at (10, 10), (11, 11), (12, 12), (13, 13)
 • Second Capture Options:
    - Must continue capturing since legal capture exists
    - Two possible capture directions:
       1. Forward: Capture B at (16, 16) to land at (17, 17)
       2. Backward: Capture A's ring at (14, 14) to land at (9, 9)
 • A Chooses Backward Capture:
    - A's cap height (1) equals target's cap height (1)
    - Jumps from (15, 15) over A's ring at (14, 14)
    - Must move at least 2 spaces (new stack height)
    - Lands on (9, 9), a valid space after A's ring meeting the distance requirement.
    - Stack now height 3, cap 1 (rings are A, B, A from top to bottom)
    - Markers at (10, 10), (11, 11), (12, 12), (13, 13) become collapsed territory
    - This creates a continuous border of A's collapsed spaces
    - If this border helps surround a region containing only B's rings, that region would become disconnected

#### 16.8.6 Territory Disconnection Example (19×19 Using Von Neumann/4-Direction Adjacency)

#### 16.8.7 Victory Through Territory Control
...
### 16.9 Comparing the Three Editions

8×8 Simplified:
 • Dual adjacency: Moore (movement/lines), Von Neumann (territory).
 • Line formation requires **4+** markers.
 • Unified move rule: "Not closer than stack height", can land on any valid space beyond markers.
 • 18 rings/player, victory at >50% of total rings.
 • Both orthogonal and diagonal movement and lines.
 • Quicker games, simpler logic.

19×19 Full:
 • Two adjacency definitions: 8-dir Moore (movement & lines), 4-dir Von Neumann (territory disconnection).
 • Line formation requires **5+** markers.
 ...
 • Lines can be formed diagonally as well.
 • Richer, more advanced environment with higher branching factor.

Hexagonal Version:
 • Regular hexagon with 11 spaces per side (331 total spaces).
 • 6-direction hexagonal adjacency used for movement, line formation, AND territory connectivity.
 • 36 rings/player, victory at >50% of total rings (same thresholds as 19x19 for 2/3/4 players).
 • Movement landing rule: Min distance, any valid space beyond markers (Unified rule).
 • Capture landing rule: Min distance, any empty beyond target (same as 19x19).
 • Unique spatial dynamics due to 6-directional movement and 3 line axes.


### 16.10 Closing Note

These three versions of RingRift offer different on-ramps to the same fundamental experience: a three-player game with stack-building, marker flipping, line formation, and territory disconnection — all fueling dynamic alliances and strategic depth. The 8×8 edition provides a more accessible introduction, the 19×19 edition presents the original ambition and complexity, and the Hexagonal version offers unique geometric properties with its six-directional movement and elegant board structure. Enjoy exploring RingRift in whichever form suits your group's appetite for depth and challenge!
...
RingRift combines multifaceted movement, capturing, and territory mechanics to create a deep and engaging strategic experience for players. By carefully managing rings, stacks, and territory while planning capture sequences and anticipating opponents' moves, players can tip the balance of power. Mastery of these interwoven dynamics offers a rewarding challenge for both casual and competitive play.
